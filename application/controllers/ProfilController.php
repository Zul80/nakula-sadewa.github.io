...
class ProfilController extends CI_Controller
{
	...
	public function index(){
		$data = array(
			'title' => 'Profil | Nakula Sadewa Digital'
		);
	...
	public function pesanan(){
		$data = array(
			'title' => 'Pesanan | Nakula Sadewa Digital',
	...
	public function detailPesanan($id){
		...
		$data = array(
			'title' => 'Detail Pesanan | Nakula Sadewa Digital',
			'pesanan' => $pesanan,
			...
			'a4brosur' => $this->BayarModel->lihat_keranjang_a4brosur($this->session->userdata('session_id'),'bayar_menunggu',$pesanan['keranjang_id'])->result_array(),
			'a5brosur' => $this->BayarModel->lihat_keranjang_a5brosur($this->session->userdata('session_id'),'bayar_menunggu',$pesanan['keranjang_id'])->result_array(),
			'a6brosur' => $this->BayarModel->lihat_keranjang_a6brosur($this->session->userdata('session_id'),'bayar_menunggu',$pesanan['keranjang_id'])->result_array(),
			'flyer10x21' => $this->BayarModel->lihat_keranjang_flyer10x21($this->session->userdata('session_id'),'bayar_menunggu',$pesanan['keranjang_id'])->result_array(),
			'kalender' => $this->BayarModel->lihat_keranjang_kalender($this->session->userdata('session_id'),'bayar_menunggu',$pesanan['keranjang_id'])->result_array(),
			'nota' => $this->BayarModel->lihat_keranjang_nota($this->session->userdata('session_id'),'bayar_menunggu',$pesanan['keranjang_id'])->result_array(),
			'dtf' => $this->BayarModel->lihat_keranjang_dtf($this->session->userdata('session_id'),'bayar_menunggu',$pesanan['keranjang_id'])->result_array(),
			'tdtf' => $this->BayarModel->lihat_keranjang_tdtf($this->session->userdata('session_id'),'bayar_menunggu',$pesanan['keranjang_id'])->result_array(),
			'lbstiker' => $this->BayarModel->lihat_keranjang_lbstiker($this->session->userdata('session_id'),'bayar_menunggu',$pesanan['keranjang_id'])->result_array(),
		);
		$this->load->view('frontend/templates/header',$data);
	...
	public function desain($id){
		$pesanan = $this->BayarModel->lihat_keranjang_faktur_by_id($id,$this->session->userdata('session_id'))->row_array();
		$data = array(
			'title' => 'Data Desain | Nakula Sadewa Digital',
			'spanduk' => $this->BayarModel->lihat_keranjang_spanduk($this->session->userdata('session_id'),'bayar_menunggu',$pesanan['keranjang_id'])->result_array(),
			'stiker' => $this->BayarModel->lihat_keranjang_stiker($this->session->userdata('session_id'),'bayar_menunggu',$pesanan['keranjang_id'])->result_array(),
			'kartu' => $this->BayarModel->lihat_keranjang_kartu($this->session->userdata('session_id'),'bayar_menunggu',$pesanan['keranjang_id'])->result_array(),
			'brosur' => $this->BayarModel->lihat_keranjang_brosur($this->session->userdata('session_id'),'bayar_menunggu',$pesanan['keranjang_id'])->result_array(),
	...
	public function detailDesain($id){
		if (isset($_POST['desain'])){
			...
			$data = array(
				'title' => 'Detail Desain | Nakula Sadewa Digital',
