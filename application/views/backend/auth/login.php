...
<body>
                ...
                <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-full-bg">
                    <div class="row w-100">
                        <div class="col-lg-4 mx-auto">
                            ...
                            <div class="alert alert-warning alert-dismissible animated fadeInDown round" style=""
							...
							?>
                            <div class="alert alert-danger alert-dismissible animated fadeInDown round" style=""
                                id="feedback" role="alert">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            ...
                            <div class="auth-form-dark text-left p-5">
                                ...
                                <br>
                                <center>
                                    <p> Copyright © 2024 <a href="#">Nakula Sadewa Digital</a>. All rights reserved.
                                    </p>
                                </center>
                            </div>
                        </div>
    ...
    <script
        src="<?= base_url() ?>assets/backend/node_modules/perfect-scrollbar/dist/js/perfect-scrollbar.jquery.min.js">
    </script>
    <!-- endinject -->
    <!-- inject:js -->
