                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('admin/pesanan/foto/' . $value['a6brosur_id']) ?>"
                                    class="badge badge-primary"><i class="fa fa-eye"></i> Lihat</a>
                            </td>
                        </tr>
                        <?php
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $value['flyer10x21_sisi'] ?></td>
                            <td><?= $value['flyer10x21_laminasi'] ?></td>
                            <td><?= $value['flyer10x21_lipat'] ?></td>
                            <td><?= $value['flyer10x21_jumlah'] ?></td>
                            <td>
                                <a href="<?= base_url('admin/pesanan/foto/' . $value['flyer10x21_id']) ?>"
                                    class="badge badge-primary"><i class="fa fa-eye"></i> Lihat</a>
                            </td>
                        </tr>
                        <?php
