...
<head>
    ...
    <title>Nakula Sadewa Digital</title>
    <!-- plugins:css -->
    <link rel="stylesheet" href="<?=base_url()?>assets/backend/node_modules/mdi/css/materialdesignicons.min.css">
    <link rel="stylesheet"
        href="<?=base_url()?>assets/backend/node_modules/simple-line-icons/css/simple-line-icons.css">
    <link rel="stylesheet" href="<?=base_url()?>assets/backend/node_modules/flag-icon-css/css/flag-icon.min.css">
    <link rel="stylesheet"
        href="<?=base_url()?>assets/backend/node_modules/perfect-scrollbar/dist/css/perfect-scrollbar.min.css">
    <!-- endinject -->
    <!-- plugin css for this page -->
    <link rel="stylesheet" href="<?=base_url()?>assets/backend/node_modules/font-awesome/css/font-awesome.min.css" />
    <link rel="stylesheet"
        href="<?=base_url()?>assets/backend/node_modules/jquery-bar-rating/dist/themes/fontawesome-stars.css">
    <link rel="stylesheet"
        href="<?=base_url()?>assets/backend/node_modules/datatables.net-bs4/css/dataTables.bootstrap4.css">
    ...
    <!-- endinject -->
    <link rel="shortcut icon" type="image/x-icon" href="<?=base_url()?>assets/frontend/img/sipesan/favicon.png" />
</head>
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row d-print-none">
            <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
                <a class="navbar-brand brand-logo" href="<?=base_url('admin')?>"><img
                        src="<?=base_url()?>assets/frontend/img/sipesan/user1.png" style="width: 100%" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="<?=base_url('admin')?>"><img
                        src="<?=base_url()?>assets/frontend/img/sipesan/favicon.png" style="width: 100%" alt="
                        logo" /></a>
            </div>
            ...
            <div class="row row-offcanvas row-offcanvas-right">
                            ...
                            <div class="collapse" id="ui-basic">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item"> <a class="nav-link"
                                            href="<?=base_url('admin/laporan/spanduk')?>">Spanduk</a></li>
                                    <li class="nav-item"> <a class="nav-link"
                                            href="<?=base_url('admin/laporan/stiker')?>">Stiker</a></li>
                                    <li class="nav-item"> <a class="nav-link"
                                    ...
                                    <li class="nav-item"> <a class="nav-link"
                                            href="<?=base_url('admin/laporan/flyer10x21')?>">Flyer 10x21</a></li>
                                    <li class="nav-item"> <a class="nav-link"
                                            href="<?=base_url('admin/laporan/kalender')?>">Kalender</a></li>
                                    <li class="nav-item"> <a class="nav-link"
                                            href="<?=base_url('admin/laporan/nota')?>">Nota</a></li>
                                    <li class="nav-item"> <a class="nav-link"
                                            href="<?=base_url('admin/laporan/dtf')?>">DTF</a></li>
                                    <li class="nav-item"> <a class="nav-link"
                                            href="<?=base_url('admin/laporan/tdtf')?>">T-Shirts | DTF</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="content-wrapper">
					...
					if ($this->session->flashdata('alert') == 'login_sukses'):
						?>
                        <div class="alert alert-success alert-dismissible animated fadeInDown" style="width: 100%"
					...
					elseif ($this->session->flashdata('alert') == 'sudah_login'):
						?>
                        <div class="alert alert-warning alert-dismissible animated fadeInDown" style="width: 100%"
                            id="feedback" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
