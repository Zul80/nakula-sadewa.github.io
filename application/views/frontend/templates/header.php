...
<body>
  ...
  <ul class="list-inline">
   <li class="test2">
    <div class="test1" style="color: #1E1E1E;">Pencarian Populer : </div>
   </li>
      <li class="test2"> <a href="idcard.php?jd=Sertifikat Vaksin" class="test1">Sertifikat Vaksin</a> </li>
      <li class="test2"> <a href="detail.php?cari=photobook&amp;search=Search" class="test1">Photobook</a> </li>
      <li class="test2"> <a href="merchandise.php?jd=T-Shirt | DTF" class="test1">T-Shirt | DTF</a> </li>
      <li class="test2"> <a href="merchandise.php?jd=Kaos Anak" class="test1">Kaos Anak</a> </li>
      <li class="test2"> <a href="dtf.php?jd=Print DTF (Pet Film Only)" class="test1">Print DTF (Pet Film Only)</a> </li>
      <li class="test2"> <a href="kategorigrid.php?kategori=Tumbler" class="test1">Tumbler Custom</a> </li>
      <li class="test2"> <a href="kategorigrid.php?kategori=Sticker Label" class="test1">Stiker Label</a> </li>
      <li class="test2"> <a href="merchandise.php?jd=E-Toll" class="test1">E-Toll</a> </li>
      <li class="test2"> <a href="kategorigrid.php?kategori=Thank You Card" class="test1">Thank You Card</a> </li>
     </ul>
 </div>
