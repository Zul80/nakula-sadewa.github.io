<div class="container">
    <header class="page-header">
        <h1 class="page-title">Pesan Brosur A5</h1>
        <ol class="breadcrumb page-breadcrumb">
            <li><a href="#">Home</a>
            </li>
            <li><a href="#">Pesan</a>
            </li>
            <li class="active">Brosur A5</li>
        </ol>
    </header>
    <div class="row">
        <?= form_open('a5brosur' , array('enctype' => 'multipart/form-data')) ?>
        <div class="col-md-5">
            <h4>Upload Gambar</h4>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select name="bahan" id="bahan" class="form-control"
                                        onchange="checkOption(); showTotalA5brosur()" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="sisi" id="sisi" class="form-control" onchange="showTotalA5brosur()"
                                        required>
                        ...
                        <div class="form-group" id="ilang" style="display: block;">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select name="lipat" id="lipat" class="form-control" onchange="showTotalA5brosur()"
                                        required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="jumlah" class="form-control" id="jumlah"
                                        onkeyup="showTotalA5brosur()" required autocomplete="off">
                                </div>
                                <div class="col-md-6">
