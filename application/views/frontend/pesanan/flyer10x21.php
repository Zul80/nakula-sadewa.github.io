<div class="container">
    <header class="page-header">
        <h1 class="page-title">Pesan Flayer 10x21</h1>
        <ol class="breadcrumb page-breadcrumb">
            <li><a href="#">Home</a>
            </li>
            <li><a href="#">Pesan</a>
            </li>
            <li class="active">Flayer 10x21</li>
        </ol>
    </header>
    <div class="row">
        <?= form_open('flyer10x21' , array('enctype' => 'multipart/form-data')) ?>
        <div class="col-md-5">
            <h4>Upload Gambar</h4>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select name="bahan" id="bahan" class="form-control"
                                        onchange="checkOption(); showTotalFlyer10x21()" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="sisi" id="sisi" class="form-control" onchange="showTotalFlyer10x21()"
                                        required>
                        ...
                        <div class="form-group" id="ilang" style="display: block;">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select name="lipat" id="lipat" class="form-control" onchange="showTotalFlyer10x21()"
                                        required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="jumlah" class="form-control" id="jumlah"
                                        onkeyup="showTotalFlyer10x21()" required autocomplete="off">
                                </div>
                                <div class="col-md-6">
