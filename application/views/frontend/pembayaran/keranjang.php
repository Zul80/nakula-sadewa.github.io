                ...
                <tbody>
                    <?php
						foreach ($a6brosur as $key => $value):
							?>
                    <tr>
                        <td><img src="<?= base_url('assets/images/a6brosur/') . $value['a6brosur_foto'] ?>" alt="foto"
                                style="width: 100%"></td>
                        <td><?= $value['a6brosur_bahan'] ?></td>
                        <td><?= $value['a6brosur_jumlah'] ?> </td>
                        <td><?= $value['a6brosur_estimasi'] ?> Hari</td>
                        <td style="text-align: right"> Rp.<?= nominal($value['a6brosur_total']) ?></td>
                        <td><a class="fa fa-close table-shopping-remove"
                                href="<?= base_url('hapus/a6brosur/' . $value['a6brosur_id']) ?>"
                                onclick="return confirm('Hapus Pesanan? ')"></a></td>
                    </tr>
                    <?php
						endforeach;
                ...
                <tbody>
                    <?php
						foreach ($flyer10x21 as $key => $value):
							?>
                    <tr>
                        <td><img src="<?= base_url('assets/images/flyer10x21/') . $value['flyer10x21_foto'] ?>" alt="foto"
                                style="width: 100%"></td>
                        <td><?= $value['flyer10x21_bahan'] ?></td>
                        <td><?= $value['flyer10x21_jumlah'] ?> </td>
                        <td><?= $value['flyer10x21_estimasi'] ?> Hari</td>
                        <td style="text-align: right"> Rp.<?= nominal($value['flyer10x21_total']) ?></td>
                        <td><a class="fa fa-close table-shopping-remove"
                                href="<?= base_url('hapus/flyer10x21/' . $value['flyer10x21_id']) ?>"
                                onclick="return confirm('Hapus Pesanan? ')"></a></td>
                    </tr>
                    <?php
						endforeach;
